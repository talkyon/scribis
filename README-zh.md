...
| 平台 | 下載連結 |
| :--- | :--- |
| **macOS** | [![Download on the App Store](https://developer.apple.com/assets/elements/badges/download-on-the-app-store.svg)](https://apps.apple.com/us/app/scribis-speech-to-text/id6761047195?mt=12) <br> .dmg (即將推出) |
| **Windows** | .exe / .msi (即將推出) |
